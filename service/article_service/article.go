...
import (
	...
	"github.com/huangzhuo492008824/go-gin-example/service/cache_service"
)
...
// 	if err := models.AddArticle(article); err {
// 		return strconv.FormatBool(err)
// 	}
...
func (a *Article) Get() (*models.Article, error) {
	...
	if gredis.Exists(key) {
		...
		if err != nil {
			...
			logging.Debug("get data from redis cache: %v", cacheArticle.ID)
